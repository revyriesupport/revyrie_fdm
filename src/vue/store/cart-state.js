...
// export const cartStoreInstance = useCartStoreDefinition;

// export const useCartStore = useCartStoreDefinition;

// window.theme = {
//   toggleCart: () => {
//     cartStoreInstance.toggle();
//   },
//   openCart: () => {
//     cartStoreInstance
//     console.log(cartStoreInstance)
//     // cartStoreInstance.open();
//   },
//   addToCart: async (item) => {
//     const response = await cartStoreInstance.addToCart(item);
//     return response;
//   },
// };